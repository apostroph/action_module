...
// 	cout<<"Perform "<<msg.states[0]<<" on "<<msg.states[1]<<endl;
// 	
// 	string actionType = msg.states[0];
// 	double x, y, z;
// 	double xf, yf, zf;
// 	x = msg.x[1];
// 	y = msg.y[1];
...
// 	zf = msg.z[0];
// 	
// 	string action_cmd = chooseAction(actionType, x, y, z, xf, yf, zf);
// 	
...
// 	
	...
	if(end > begin){
		elapsedTime += (double)(end.toSec()-begin.toSec());
	}
	begin = ros::Time::now();
    }
    ros::shutdown();
